...
// EditPostData holds the post data plus a boolean for login status.
...
func EditPostHandler(db *sql.DB, w http.ResponseWriter, r *http.Request) {
    ...
    if r.Method == http.MethodGet {
        ...
        // Pass a composite data struct with IsLoggedIn and Post.
        data := EditPostData{
            IsLoggedIn: loggedIn,
            Post:       post,
        }

        // Render the edit-post template with the composite data.
